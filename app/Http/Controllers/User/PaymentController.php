...
{   
    ...
    public function payPrePaid(Request $request)
    {
        ...
        if ($request->value < 1) {
            if ($type == 'lifetime') {
                ...
                auth()->user()->gpt_4o_mini_credits_prepaid = auth()->user()->gpt_4o_mini_credits_prepaid + $plan->gpt_4o_mini_credits_prepaid;
                auth()->user()->o1_preview_credits_prepaid = auth()->user()->o1_preview_credits_prepaid + $plan->o1_preview_credits_prepaid;
                auth()->user()->o1_mini_credits_prepaid = auth()->user()->o1_mini_credits_prepaid + $plan->o1_mini_credits_prepaid;
                ...
                auth()->user()->image_credits_prepaid = auth()->user()->image_credits_prepaid + $plan->images;
    ...
    private function registerSubscriptionPayment(SubscriptionPlan $plan, User $user, $subscriptionID, $gateway)
    {
        ...
        $record_payment->o1_preview_credits = $plan->o1_preview_credits;
        $record_payment->o1_mini_credits = $plan->o1_mini_credits;
