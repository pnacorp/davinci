    ...
    {  
        ...
        return response()->stream(function () use($conversation_id, $googlePrompt, $prompt, $user_prompt) {
            ...
            if (is_null($chat_message->images)) {
                ...
                if ($model == 'claude-3-opus-20240229' || $model == 'claude-3-5-sonnet-20241022' || $model == 'claude-3-5-haiku-20241022') {
                    $messages = [];
                ...
                if ($model == 'claude-3-opus-20240229' || $model == 'claude-3-5-sonnet-20241022' || $model == 'claude-3-5-haiku-20241022') {
                    ...
                    try {
                        $prompt = $main_prompt . ' Based on previous information about your role, answer this user question: ' . $user_prompt; 
                    ...
                    if ($model == 'o1-mini' || $model == 'o1-preview') {
                        $results = \OpenAI\Laravel\Facades\OpenAI::chat()->create([
                            'model' => $model,
                            'messages' => [
                ...
                if ($model == 'claude-3-opus-20240229' || $model == 'claude-3-5-sonnet-20241022' || $model == 'claude-3-5-haiku-20241022' || $model == 'gemini_pro') {
                    $model = 'gpt-4o-mini';
                }
